...
当前语料包含 9 条项目自行编写的中文摘要，链接 CDC、NHS 和 WHO，并明确标记为
...
24 条记录目标；自动报告会显示当前 9/24 条记录以及每个剩余缺口。胃肠道症状和
呼吸系统症状均已达到文档数与多来源门槛。[第二批审计记录](docs/corpus-v1-batch-2.md)
