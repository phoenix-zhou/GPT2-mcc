...
class ParameterConfig():
    def __init__(self):
        ...
        # 词典路径：在vocab文件夹里面
        self.vocab_path = '/www/py-data/LLM/Gpt2_Chatbot/vocab/vocab.txt'
        # 训练文件路径
        self.train_path = '/www/py-data/LLM/Gpt2_Chatbot/data/medical_train.pkl'
        # 验证数据文件路径
        self.valid_path = '/www/py-data/LLM/Gpt2_Chatbot/data/medical_valid.pkl'
        # 模型配置文件
        self.config_json = '/www/py-data/LLM/Gpt2_Chatbot/config/config.json'
        # 模型保存路径
        self.save_model_path = '/www/py-data/LLM/Gpt2_Chatbot/save_model'
        # 如果你有预训练模型就写上路径（我们本次没有直接运用GPT2预训练好的模型，而是仅只用了该模型的框架）
        self.pretrained_model = ''
        # 保存对话语料
        self.save_samples_path = '/www/py-data/LLM/Gpt2_Chatbot/sample'
